...
<div class="cal-plugin flex-media dir-row-media just-cont-btw-media">
  ...
  <section class="bar-graph flex-media dir-col-media just-cont-btw-media">
      <h3> With Lendified you could save up to <span id="amount-saved" class="text-green">$13,015</span> in interest </h3>
    ...
    <h6>Estimated Total Interest Cost
      <span role="tooltip" class="fa fa-question-circle-o" aria-hidden="true" title="hello calculator"></span>
    </h6>
  </section>
